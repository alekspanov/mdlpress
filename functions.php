...
//	wp_enqueue_style( 'mdlpress-style', get_stylesheet_directory_uri() . '/style.css');
	...
	wp_enqueue_script( 'mdl-js', get_template_directory_uri() . '/js/dist/scripts.min.js', array(), '1.0.1', true );
...
/**
 * Implement the nav-walker mdl liht feature.
 */
